        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item m-auto">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <span class="brand-logo">
                        ...
                        <img src="{{ asset('app-assets/images/dash_images/logo.svg') }}" alt="">
                    </span>
            ...
            <li class="nav-item nav-toggle">
                <a class="nav-link modern-nav-toggle pe-0" data-bs-toggle="collapse">
                    ...
                    {{-- <i class="feather feather-disc d-none d-xl-block collapse-toggle-icon primary font-medium-4" data-feather="disc" data-ticon="disc" style="display: none;"></i> --}}
                </a>
            </li>
        </ul>
    </div>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                <a class="d-flex align-items-center" href="form-wizard.html">
                    <img src="{{ asset('app-assets/images/dash_images/updates.svg') }}" alt="" class="me-1">
                    <span class="menu-title text-truncate" data-i18n="Form Wizard">Updates</span>
                </a>
            </li>
        </ul>
    </div>
