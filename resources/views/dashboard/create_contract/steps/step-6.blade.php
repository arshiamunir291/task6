<div class="S_step6 d-none">
    ...
    <div class="NextBtns_botsWrap">
        <div class="NextBtns_bots justify-content-end px-2">
            ...
            <div class="InnerBtns">
                <button type="button" class="backBtn S_StepBack_5">Back</button>
                <button type="button" class="startedBtn next-step Goto_S_step7">Next</button>
            </div>
        </div>
    </div>
</div>